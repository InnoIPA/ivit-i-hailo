...
def build_argparser():
    ...
    common_model_args.add_argument('-topk', help='Optional. Number of top results. Default value is 5.', default=5,
                                   type=int)

    infer_args = parser.add_argument_group('Inference options')
    # infer_args.add_argument('--async_mode', action='store_true', help='Setup Async Inference Mode')
